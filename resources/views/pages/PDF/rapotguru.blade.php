...
<body>
	<table width="100%;">
		<thead>
			<tr>
				<td><b style="color: #000000;">Rapot Guru SMK Assalaam Bandung</b></td>
				<td style="text-align: right;">Semester 1 / Tahun Ajaran 2018/2019</td>
			</tr>
		</thead>
	</table>
    <center>
    <p>Kepada yang terhormat :</p>
    <p><b><span style="text-decoration: underline; color: #000000;">{{$rapot->guru->nama_guru}}</span></b></p>
    </center>
    <?php
        ...
        <center><h5>Data dan analisa kinerja adalah sebagai berikut:</h5></center>
            ...
            <table style="width: 100%; text-align: right">
                <tbody>
                    <tr>
                        <td>&nbsp;</td>
                        <td style="text-align: center;">Bandung,{{ \Carbon\Carbon::now()->format('d F Y') }}</td>
                    </tr>
                    <tr>
                        <td>&nbsp;</td>
                    ...
                    <tr>
                        <td>&nbsp;</td>
                        <td style="text-align: center;">H.M. Luthfi Almanfaluthi,S.T</td>
                    </tr>
                </tbody>
            </table>
</body>
