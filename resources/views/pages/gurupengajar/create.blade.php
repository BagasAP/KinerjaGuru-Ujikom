...
<div class="container">
  <div class="row">
    <div class="col-xs-12">
      <div class="page-title-box">
              <h4 class="page-title">Tambah Guru Pengajar</h4>
              <ol class="breadcrumb p-0 m-0">
                  <li>
                      <a href="#">Identitas</a>
                  </li>
                  <li>
                      <a href="{{ url('identitas/gurupengajar') }}">Guru Pengajar</a>
                  </li>
                  <li class="active">
  ...
  <form method="post" action="{{ route('gurupengajar.store') }}" id="form-guru" enctype="multipart/form-data">
    {{ csrf_field() }}
    <div class="row">
      <div class="col-xs-9">
        <div class="card-box">
