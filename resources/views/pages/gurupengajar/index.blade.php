...
@section('content')
    ...
    <div class="row">
		<div class="col-xs-12">
			<div class="page-title-box">
                <h4 class="page-title">Guru Pengajar</h4>
                <ol class="breadcrumb p-0 m-0">
                    <li>
                        <a href="#">Identitas</a>
                    </li>
                    <li class="active">
                        <a href="#">Guru Pengajar</a>
                    </li>
                </ol>
    ...
    <div class="row">
    	<div class="col-md-12 m-b-20">
    		<div class="pull-left">
    		 	        <a href="{{ url('identitas/gurupengajar/create') }}" class="btn btn-danger btn-bordered waves-effect waves-light"><i class="fa fa-plus"></i> Tambah Guru Pengajar</a>
    		</div>
    ...
    <div class="row" style="position: relative"> 
        @if (count($guru) > 0)
            <section class="guru">
                @include('pages.gurupengajar.load_data')
            </section>
        @else
