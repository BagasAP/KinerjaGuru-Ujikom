...
<div class="container">
		...
		<div class="col-xs-12">
			<div class="page-title-box">
	            ...
	            <ol class="breadcrumb p-0 m-0">
	                ...
	                <li>
	                    <a href="{{ url('identitas/guruinti') }}">Guru </a>
	                </li>
	                <li class="active">
	                    Ubah Guru
	                </li>
	...
	<form method="post" action="{{ url('identitas/guruinti/'.$guru->id) }}" id="form-guru">
		{{ csrf_field() }}
	              			...
	              			<div class="row">
	                			<div class="col-md-12">
	                  				<div class="form-group">
										...
										<input type="text" name="jenis_kelamin" class="form-control" placeholder="" required="required" value="{{ $guru->jenis_kelamin }}">
										<span class="help-block"></span>
									</div>
	                			</div>
	             			 </div>
	          		...
	          		<div class="row">
	            		<div class="col-md-6">
	              			<div class="form-group">
	                			...
	                			<input type="text" name="agama" class="form-control" placeholder="" required="required" value="{{ $guru->agama }}">
	                			<span class="help-block"></span>
	              			</div>
	              			<div class="form-group">
