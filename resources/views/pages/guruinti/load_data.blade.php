    	...
    	<div class="text-center card-box">
            ...
            <div class="member-card">
                ...
                <div>
                    ...
                    <a href="{{ url('identitas/guruinti/'.$data_guru->id.'/edit') }}" class="btn btn-warning"><i class="mdi mdi-pencil"></i> Ubah</a>
                    <a href="{{ url('identitas/guruinti/'.$data_guru->id) }}" class="btn btn-primary"><i class="mdi mdi-arrow-expand"></i> Lihat</a>
                    <form action="{{route('guruinti.destroy', $data_guru->id )}}" method="post">
